...
"""
import sys
sys.path.append('kochat이 설치된 최상위 파일 경로')
...
from scenario import dust, weather, travel, restaurant, rent, eco_activity, term
...
kochat = KochatApi(
    ...
    scenarios=[
        weather, dust, travel, restaurant, rent, eco_activity, term
    ]
)
